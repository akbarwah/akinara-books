...
// --- DATA BUKU BEST SELLER (Ditambah Type & Age) ---
const booksData = [
    { 
        id: 1, 
        title: "Ushborne: Pull-back Busy Train Book", 
        price: "Rp 125.000", 
        type: "Board Book",  // TAMBAHAN
        age: "0-2 Thn",      // TAMBAHAN
        author: "Fiona Watt",
    ...
    { 
        ...
        price: "Rp 95.000", 
        type: "Hardcover",    // TAMBAHAN
        age: "3-5 Thn",       // TAMBAHAN
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-40 overflow-hidden bg-[#FFF9F0]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <Reveal delay={200}>
            <div className="relative inline-block">
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold text-[#8B5E3C] mb-6 leading-tight relative z-10">Buka Buku, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF9E9E] to-[#9D84B7]">Buka Imajinasi.</span></h1>
            </div>
        </Reveal>
        <Reveal delay={400}>
            <p className="text-lg md:text-xl text-[#6D4C41] mb-10 max-w-2xl mx-auto leading-relaxed">Selamat datang di <strong>Akinara Books & Library</strong>. Kami menyediakan buku anak pilihan dari seluruh dunia untuk menemani masa kecil si buah hati.</p>
        </Reveal>
        <Reveal delay={600}>
      ...
      <div className="absolute bottom-0 left-0 w-full leading-none overflow-hidden rotate-180">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[calc(100%+1.3px)] h-[60px] md:h-[100px] fill-white"><path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z"></path></svg>
      </div>
    </section>
  );
};
...
const Features = () => {
  const features = [
    { icon: <Star className="w-6 h-6 text-yellow-500" />, title: "Koleksi Pilihan", desc: "Buku-buku terbaik yang dikurasi khusus untuk mendukung tumbuh kembang anak." },
    { icon: <Truck className="w-6 h-6 text-blue-500" />, title: "Pengiriman Luas", desc: "Melayani pengiriman ke seluruh Indonesia dengan packing aman dan rapi." },
    { icon: <Heart className="w-6 h-6 text-pink-500" />, title: "Ramah Anak", desc: "Setiap buku dipilih dengan mempertimbangkan keamanan dan nilai edukatif." },
  ];
  return (
    <section className="py-20 bg-white" id="tentang">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <Reveal><h2 className="text-3xl md:text-4xl font-bold text-[#8B5E3C] mb-4">Mengapa Memilih Kami?</h2></Reveal>
        <Reveal delay={200}><p className="text-[#6D4C41] max-w-4xl mx-auto mb-16">Kami berkomitmen menghadirkan buku-buku berkualitas untuk menemani petualangan belajar si kecil.</p></Reveal>
...
// 4. Catalog Preview (With Modal & Badges)
    ...
    <section className="py-20 bg-gradient-to-b from-white to-[#FFF9F0]" id="katalog">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <div className="flex flex-col items-center gap-3 mb-12">
            <Reveal><span className="inline-block px-4 py-1.5 bg-[#FF9E9E] text-white rounded-full text-sm font-bold tracking-wide shadow-sm mb-2">KOLEKSI TERBARU</span></Reveal>
