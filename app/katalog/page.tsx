...
interface FilterBarProps {
  ...
  // ✅ FIX: Sudah string[] murni, bukan (string | undefined)[]
  uniqueAges: string[];
  uniqueTypes: string[];
  ...
  return (
    ...
    >
      ...
      <div className="aspect-3/4 rounded-xl overflow-hidden mb-4 relative bg-gray-100">
        {/* ✅ img dengan lazy loading + error handling */}
        <img
          src={imgSrc}
      ...
      <h3 className="font-bold text-[#8B5E3C] mb-1 line-clamp-2 leading-tight text-left grow">
        {displayBook.title}
      </h3>
      <div className="mt-2">
...
// ============================================================
// KOMPONEN: KATALOG CONTENT (butuh Suspense karena useSearchParams)
// ============================================================
function KatalogContent() {
  ...
  // ✅ FIX: Reset filter sekaligus reset URL
  ...
  // ✅ FIX: Type-safe filter dengan type guard `(x): x is string`
  // Ini memastikan TypeScript tahu hasilnya pasti string[], bukan (string | undefined)[]
  ...
  // Handle klik rekomendasi di dalam modal
  ...
  return (
    <>
        ...
        <Reveal>
          <div className="text-center mb-10">
            ...
            <p className="text-[#6D4C41] text-base md:text-lg max-w-2xl mx-auto">
              Temukan buku yang tepat berdasarkan usia, status ketersediaan,
              atau kategori.
            </p>
          </div>
        </Reveal>
      ...
      {/* ✅ CartDrawer — shared, sudah ada animasi close */}
      <CartDrawer />
    </>
  );
}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            {/* ✅ FIX: Cart button sekarang berfungsi + ada badge count */}
            <button
